...
static void show_tsg_usage() {
    ...
    AUI_PRINTF("such as :6 /mnt/uda1/tvstream.ts,234,235,234,0,1,0");
...
*                                         
*   TS route:local media file-->TSG-->TSI-->DMX-->KL-->DSC-->DMX-->|-->DECA------->SND-->|--->HDMI
*                                                                  |-->DECV-->|--->DIS-->|
*                                                                  |-->SUBT-->|
*
*   
*/
unsigned long test_tsg_dsc_kl(unsigned long *argc,char **argv,char *sz_out_put)
{
